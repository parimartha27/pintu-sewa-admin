...
export default function SideBar({ navigation }: { navigation: string }) {
  ...
  return (
    <>
      ...
      >
        <div>
          <h2 className="flex flex-row gap-2 items-center text-xl font-bold p-5">
            PINTU SEWA
          </h2>
          <nav>
            <a
              ...
              className={`flex items-center gap-2 text-md p-5 font-medium hover:text-blue-400 ${
                navigation == "dashboard" ? "text-blue-300" : ""
              }`}
            >
            ...
            <a
              ...
              className={`flex items-center gap-2 text-md p-5 font-medium hover:text-blue-400 ${
                navigation == "pelanggan" ? "text-blue-300" : ""
              }`}
            >
            ...
            <a
              ...
              className={`flex items-center gap-2 text-md p-5 font-medium hover:text-blue-400 ${
                navigation == "keluhan" ? "text-blue-300" : ""
              }`}
            >
