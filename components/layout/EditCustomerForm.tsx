...
export default function EditCustomerForm() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`https://pintu-sewa-backend.up.railway.app/api/customers/${data.customerId}`)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (currentData === formData) {
      ...
      try {
        const response = await axios.put<PostResponse>("https://pintu-sewa-backend.up.railway.app/api/admin/manage-customer/edit-biodata", formData)
